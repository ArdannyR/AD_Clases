...
class CalculadoraStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Sumar = channel.unary_unary(
                '/Calculadora/Sumar',
                request_serializer=calculadora__pb2.parametros.SerializeToString,
...
def add_CalculadoraServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Sumar': grpc.unary_unary_rpc_method_handler(
                    servicer.Sumar,
                    request_deserializer=calculadora__pb2.parametros.FromString,
...
class Calculadora(object):
    ...
    def Sumar(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculadora/Sumar',
            calculadora__pb2.parametros.SerializeToString,
